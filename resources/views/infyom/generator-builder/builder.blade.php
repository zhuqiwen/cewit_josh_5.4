                            ...
                            <tr class="item" style="display: table-row;">
                                ...
                                <td style="vertical-align: middle">
                                    <select class="form-control drdHtmlType" style="width: 100%">
                                        <option value="text" class="htmltext">Text</option>
                                    ...
                                    <input type="text" class="form-control htmlValue txtHtmlValue" style="display: none;margin-top: 10px"
                                           placeholder=""/>
                                </td>
                                <td style="vertical-align: middle">
...
//        $(function () {
//            $('body').bind('click.txtValidation', function () {
//                alert('hhjhj');
//            });
//        });
...
//        $('.txtdbType').closest('tr').find('.checkbox').attr('disabled', true);
        $(document.body).on("change",".txtdbType",function(){
            ...
            if( db_type == 'boolean' ){
                ...
                $(this).closest('tr').find('.txtValidation option').not('.boolean,.required').attr('disabled', true);
//                $('.txtdbType').closest('tr').find('.checkbox').attr('disabled', false);
            ...
            if( db_type == 'date'  ){
                ...
                $(this).closest('tr').find('.txtValidation option').not('.date,.required').attr('disabled', true);
        ...
        // Validations auto hide after select one option
        $('body').bind('click.txtValidation', function () {
            var selected_validation = $(this).closest('tr').find('.txtValidation').val();
            var db_type= $(this).closest('tr').find('.txtdbType').val();
            if(db_type == 'boolean' && selected_validation == 'required'){

                $(this).closest('tr').find('.txtValidation option').not('.required').attr('disabled', true);
            }else if(db_type == 'boolean' && selected_validation == 'boolean'){
                $(this).closest('tr').find('.txtValidation option').not('.boolean').attr('disabled', true);
            }
            else{
                $(this).closest('tr').find('.txtValidation option').not('.required, .boolean').attr('disabled', false);
            }
            });
...
//            });
            $(".txtValidation").select2({
                ...
                if(selected_validation == 'email'){
                    $(this).closest('tr').find('.txtValidation option').not('.email,.required').attr('disabled', true);
                 }
                else if(selected_validation == 'date'){
                    $(this).closest('tr').find('.txtValidation option').not('.date,.required').attr('disabled', true);
                }
                else if(selected_validation == 'integer'){
                    $(this).closest('tr').find('.txtValidation option').not('.integer,.required').attr('disabled', true);
                }
                    ...
                    $(this).closest('tr').find('.txtValidation option').attr('disabled', false);
                }
        });
        // End Validations auto hide after select one option
        var canReload = true;
...
//                }
                ...
                $('#btnGenerate').one('click',function() {
                    canReload = false;
                    var fieldArr = [];
