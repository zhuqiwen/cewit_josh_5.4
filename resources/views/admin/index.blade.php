    ...
    <section class="content">
        <div class="row">
            ...
            <a href="{{route('admin.ctStudents.index')}}">
                <div class="col-md-6 col-sm-12 margin_10 animated fadeInLeftBig">
                            ...
                            <div class="col-xs-12 pull-left nopadmar">
                                <div class="row">
                                    <div class="square_box col-xs-7 pull-left">
                                        ...
                                        <div class="number" id="count_num_students"></div>
                                    </div>
                                    <i class="livicon pull-right" data-name="ghost" data-l="true" data-c="#fff"
            ...
            <a href="{{route('admin.ctFaculties.index')}}">
                <div class="col-md-6 col-sm-12 margin_10 animated fadeInRightBig">
                    <!-- Trans label pie charts strats here-->
                            ...
                            <div class="col-xs-12 pull-left nopadmar">
                                <div class="row">
                                    ...
                                    <div class="square_box col-xs-7 pull-left">
                                        ...
                                        <div class="number" id="count_num_faculties"></div>
                                    </div>
...
@section('footer_scripts')
    <script type="text/javascript">
        ...
        var num_faculties = {{$num_faculties}};
    </script>
    ...
    <script src="{{ asset('assets/js/pages/dashboard_demo.js') }}" type="text/javascript"></script>
